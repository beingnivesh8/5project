...
st.set_page_config(page_title='Singapore Resale Flat Prices Predicting',page_icon='https://upload.wikimedia.org/wikipedia/en/7/72/Housing_and_Development_Board_%28logo%29.png',initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by N.P.Nivesh.'})
st.header(":rainbow[Singapore Resale Flat Prices Predicting]")
    ...
    if button:
        with st.spinner("Predicting..."):
            ...
            if not all([user_month,user_town,user_flat_type,user_flat_model,floor_area_sqm,price_per_sqm,year,block,
                ...
                with open(r'Decisiontree.pkl','rb') as files:
...
if selected == "Home":
    ...
    st.image('https://theonlinecitizen.s3.ap-northeast-2.amazonaws.com/uploads/2022/12/26205241/hdb-yishun.webp')
...
if selected == "About":
    ...
    st.markdown('''**Hello! I'm Nivesh, a Logistics Team member with a keen interest in data science and analytics.
